        ...
        <div className="flex items-center justify-between py-5 font-medium">
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    {/* space ka issue keep in mind ki ek space se issue ho skte hai */}
                ...
                <img onClick={() => setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden lg:hidden' alt="" />
            </div>

            {/* sidebar menu onVisible pe true krke it will show small screens ke liye*/}
